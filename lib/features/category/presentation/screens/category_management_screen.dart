...
class _CategoryManagementScreenState extends State<CategoryManagementScreen> {
  ...
  void _openForm({CategoryEntity? existing}) {
    showDialog(
      context: context,
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.symmetric(
                              ...
                              vertical: isMobile ? AppSpacing.xs : AppSpacing.md,
                            ),
                            child: Row(
                              children: [
                                Expanded(
                                ...
                                IconButton(
                                  icon: Icon(Icons.edit,
                                      size: isMobile ? 14 : 16, color: AppColors.primary),
